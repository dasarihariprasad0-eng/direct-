...
load_dotenv()
# here we set a secret key so only a few members can acess

if st.text_input("enter password:", type = "password") != os.environ.get("SECRET_KEY"):
    st.warning("🛅 it is locked enter the correct key!")
    st.stop()
